...
export const COIN_PACKS: CoinPack[] = [
  { coins: 500, id: 'coins_500', label: 'Starter Stack', priceLabel: '$4.99' },
  { coins: 1200, id: 'coins_1200', label: 'Playmaker Pack', priceLabel: '$9.99' },
  { coins: 2800, id: 'coins_2800', label: 'Commissioner Vault', priceLabel: '$19.99' },
];
...
export const COSMETIC_CATEGORY_DESCRIPTIONS: Record<CosmeticCategory, string> = {
  ...
  lock_effect: 'Effects that make your Lock of the Week pop.',
...
export const COSMETIC_ITEMS: CosmeticItem[] = [
  ...
  { accent: amber, category: 'team_logo', cost: 150, description: 'Fast, sharp, and built for underdog slips.', id: 'logo_blitz_fox', icon: 'flash', name: 'Blitz Fox', styleKey: 'fox' },
  ...
  { accent: red, category: 'team_logo', cost: 225, description: 'A chaos-heavy identity for high-variance bettors.', id: 'logo_chaos_bear', icon: 'warning', name: 'Chaos Bear', styleKey: 'bear' },
  ...
  { accent: green, category: 'team_logo', cost: 225, description: 'A moneyline-first logo with sharp edges.', id: 'logo_cash_shark', icon: 'cash', name: 'Cash Shark', styleKey: 'shark' },
  ...
  { accent: red, category: 'team_logo', cost: 200, description: 'A spicy meme badge for emotional hedgers.', id: 'logo_salty_goat', icon: 'happy', name: 'Salty Goat', styleKey: 'goat' },
  { accent: amber, category: 'team_logo', cost: 250, description: 'A printer-themed badge for weekly profit runs.', id: 'logo_money_press', icon: 'print', name: 'Money Press', styleKey: 'press' },
  ...
  { accent: green, category: 'team_logo', cost: 200, description: 'A laser-eyed logo for the Sunday sweat.', id: 'logo_laser_cat', icon: 'scan', name: 'Laser Cat', styleKey: 'laser' },
  ...
  { accent: green, category: 'trophy_skin', cost: 500, description: 'A loud money-printer championship skin.', id: 'trophy_money_printer', icon: 'print', name: 'Money Printer', styleKey: 'printer' },
  ...
  { accent: gold, category: 'lock_effect', cost: 200, description: 'A quick lightning strike around Lock cards.', id: 'lock_lightning', icon: 'flash', name: 'Lightning Bolt', styleKey: 'lightning' },
  { accent: cyan, category: 'lock_effect', cost: 225, description: 'Frosted edges and icy glow on Lock picks.', id: 'lock_frost', icon: 'snow', name: 'Ice/Frost', styleKey: 'frost' },
  ...
  { accent: green, category: 'win_celebration', cost: 200, description: 'A money-rain celebration after a winning matchup.', id: 'celebration_money_rain', icon: 'cash', name: 'Money Rain', styleKey: 'money' },
  ...
  { accent: green, category: 'chat_sticker_pack', cost: 150, description: 'Cash-themed reactions for big hits.', id: 'stickers_moneyline', icon: 'cash', name: 'Moneyline Pack', styleKey: 'moneyline' },
  { accent: cyan, category: 'chat_sticker_pack', cost: 150, description: 'Sweat-friendly reactions for live games.', id: 'stickers_sweat', icon: 'water', name: 'Sunday Sweat Pack', styleKey: 'sweat' },
